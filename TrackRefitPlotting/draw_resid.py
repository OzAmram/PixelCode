...
if __name__ == "__main__":
    ...
    h_residy_ontrack = TH2F("residy_ontrack","", 50, 0, 500, 2,0,1.2)
    ...
    h_resid_ontrack = TH2F("resid_ontrack","", 50, 0, 500, 2,0,1.2)
    getOnTrackHist_v2(h_resid_ontrack, pTree)
